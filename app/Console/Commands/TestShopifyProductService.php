...
class TestShopifyProductService extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:TestShopifyProductService';
     ...
     * @var string
     */
    protected $description = 'Test Shopify Product Service';
